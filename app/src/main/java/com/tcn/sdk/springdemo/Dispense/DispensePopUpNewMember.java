...
//
//public class DispensePopUpNewMember {
//    private final ByteArrayOutputStream mBuffer = new ByteArrayOutputStream();
//    private final String TAG = "DispensePopUpNewMember";
...
//
//    public void DispensePopUp(SelectPaymentActivity activity, UserObj userobj, String paystatus, String payid, RequestQueue requestQueue) {
//        RollingLogger.i(TAG, "DispensePopUpNewMember start");
//
...
//                            sdthankyou.setTitleText("Thank you.").setContentText("Your order is dispensed please get ready to pickup.");
//                        }
