...
public class CartListAdapter2025Back extends RecyclerView.Adapter<CartListAdapter2025Back.CartListAdapterViewHolder> {
    ...
    public CartListAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.dispnsingrecyclercard, parent, false);
    ...
    public void onBindViewHolder(@NonNull CartListAdapterViewHolder holder, int position) {
        ...
        holder.getNumber().setText(productNumber);
