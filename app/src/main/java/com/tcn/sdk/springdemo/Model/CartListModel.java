...
public class CartListModel implements Serializable {
    ...
    public ArrayList<String> itemStatus = new ArrayList<>();
    ...
    public static String getProductIds(List<CartListModel> cartListModels) {
        StringBuilder productIds = new StringBuilder();
        for (CartListModel cn : cartListModels) {
            int qty;
            qty = Integer.parseInt(cn.getItemqty());
            for (int x = 0; x < qty; x++) {
                productIds.append(cn.getProdid()).append(",");
            }
        }
    ...
    public void setItemStatus(ArrayList<String> itemStatus) {
