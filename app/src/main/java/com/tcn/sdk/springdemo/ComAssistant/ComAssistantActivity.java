...
//        editTextCOMC = findViewById(R.id.editTextCOMC);
//        editTextCOMD = findViewById(R.id.editTextCOMD);
//        editTextTimeCOMA = findViewById(R.id.editTextTimeCOMA);
//        editTextTimeCOMB = findViewById(R.id.editTextTimeCOMB);
//        editTextTimeCOMC = findViewById(R.id.editTextTimeCOMC);
//        editTextTimeCOMD = findViewById(R.id.editTextTimeCOMD);
//
...
//        checkBoxAutoCOMC = findViewById(R.id.checkBoxAutoCOMC);
//        checkBoxAutoCOMD = findViewById(R.id.checkBoxAutoCOMD);
//        ButtonClear = findViewById(R.id.ButtonClear);
//        ButtonSendCOMA = findViewById(R.id.ButtonSendCOMA);
//        ButtonSendCOMB = findViewById(R.id.ButtonSendCOMB);
//        ButtonSendCOMC = findViewById(R.id.ButtonSendCOMC);
//        ButtonSendCOMD = findViewById(R.id.ButtonSendCOMD);
//        toggleButtonCOMA = findViewById(R.id.toggleButtonCOMA);
//        toggleButtonCOMB = findViewById(R.id.ToggleButtonCOMB);
//        toggleButtonCOMC = findViewById(R.id.ToggleButtonCOMC);
//        toggleButtonCOMD = findViewById(R.id.ToggleButtonCOMD);
//        SpinnerCOMA = findViewById(R.id.SpinnerCOMA);
//        SpinnerCOMB = findViewById(R.id.SpinnerCOMB);
//        SpinnerCOMC = findViewById(R.id.SpinnerCOMC);
//        SpinnerCOMD = findViewById(R.id.SpinnerCOMD);
//        SpinnerBaudRateCOMA = findViewById(R.id.SpinnerBaudRateCOMA);
//        SpinnerBaudRateCOMB = findViewById(R.id.SpinnerBaudRateCOMB);
//        SpinnerBaudRateCOMC = findViewById(R.id.SpinnerBaudRateCOMC);
//        SpinnerBaudRateCOMD = findViewById(R.id.SpinnerBaudRateCOMD);
...
//            }
//        } else {
//            Toast.makeText(this, "No serial port / devices found", Toast.LENGTH_LONG).show();
//        }
//
//
